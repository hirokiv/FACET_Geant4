...
cat d_electron_temp.txt | sed -e '2000001,$d' > beam_d_electron.txt
...
cat d_positron_temp.txt | sed -e '2000001,$d' > beam_d_positron.txt
...
cat d_photon_temp.txt   | sed -e '2000001,$d' > beam_d_photon.txt
...
cat d_elec_prm_temp.txt | sed -e '2000001,$d' > beam_d_elec_prm.txt
...
cat d_elec_sec_temp.txt | sed -e '2000001,$d' > beam_d_elec_sec.txt
...
cat t_electron_temp.txt | sed -e '2000001,$d' > beam_t_electron.txt
...
cat t_positron_temp.txt | sed -e '2000001,$d' > beam_t_positron.txt
...
cat t_photon_temp.txt   | sed -e '2000001,$d' > beam_t_photon.txt
...
cat t_elec_prm_temp.txt | sed -e '2000001,$d' > beam_t_elec_prm.txt
...
cat t_elec_sec_temp.txt | sed -e '2000001,$d' > beam_t_elec_sec.txt
