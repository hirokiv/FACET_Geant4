...
SensitiveVirtual::SensitiveVirtual(const G4String& name, const G4String& hitsCollectionName)
  : G4VSensitiveDetector(name), fHitsCollection(NULL)
{
  collectionName.insert(hitsCollectionName);
}

SensitiveVirtual::~SensitiveVirtual()
{}

void SensitiveVirtual::Initialize(G4HCofThisEvent* hce)
{
  //Create hits collection
  fHitsCollection = new VirtualHitsCollection(SensitiveDetectorName, collectionName[0]);
...
//------------------------------------------------------------------------------
G4int SensitiveVirtual::WriteBeamFile(G4String filename, G4ThreeVector position_World,
...
G4bool SensitiveVirtual::ProcessHits(G4Step* aStep, G4TouchableHistory*)
{
  VirtualHit* newHit = new VirtualHit();
...
void SensitiveVirtual::EndOfEvent(G4HCofThisEvent*)
{
}
